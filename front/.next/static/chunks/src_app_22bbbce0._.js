...
"[project]/src/app/item/detalhes/[itemId]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function ItemDetalhes() {
    ...
    async function carregarItem() {
        try {
            const resposta = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$Services$2f$api$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/item/buscaritemporid/${itemId}`);
            setItem(resposta.data);
            try {
                const resposta = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$Services$2f$api$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/comentario/listarComentarioPorItem/${itemId}`);
    ...
    async function excluir(comentarioId) {
        try {
            const resposta = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$Services$2f$api$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/comentario/excluir/${comentarioId}/${itemId}`);
            setComentarios(resposta.data);
        } catch (erro) {
            console.error(erro);
    ...
    function cadastrar() {
        ...
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$Services$2f$api$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/comentario/cadastrar", comentario).then((resposta)=>{
                setComentarios(resposta.data);
                setTexto("");
            }).catch((erro)=>{
                console.error(erro);
...
_s(ItemDetalhes, "hvTB2n0sfPRntr5H/IIUQ62qWB8=", false, function() {
    return [
...
var _c;
__turbopack_context__.k.register(_c, "ItemDetalhes");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_app_22bbbce0._.js.map